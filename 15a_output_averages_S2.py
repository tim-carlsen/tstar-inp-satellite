...
mask_djf_n = np.ma.masked_less(data_djf.where((T_star_djf.lat >= 60.)), 0.5)
mask_jja_n = np.ma.masked_less(data_jja.where((T_star_djf.lat >= 60.)), 0.5)

mask_djf_s = np.ma.masked_less(data_djf.where((T_star_djf.lat <= -55.)), 0.5)
mask_jja_s = np.ma.masked_less(data_jja.where((T_star_djf.lat <= -55.)), 0.5)
...
cs2 = plt_var_polar(fig, axs[0,1], lon2d-2.5, lat2d-2.5, T_star_djf.where((ice_n_djf_regrid == 100.) & (T_star_djf.lat > 60.)), 'T_star DJF', 'N', discrete_cmap(16, cm_crameri.oslo), vmin = 238, vmax = 270, n_cmap = 16)
...
cs3 = plt_var_polar(fig, axs[1,0], lon2d-2.5, lat2d-2.5, T_star_djf.where((ice_s_djf_regrid == 100.) & (T_star_djf.lat < -50.)), 'T_star DJF', 'S', discrete_cmap(16, cm_crameri.oslo), vmin = 238, vmax = 270, n_cmap = 16)
...
mask_arctic_jja_ocean = T_star_jja.where((ice_n_jja_regrid < 100.) & (land_mask_n_regrid == 1.) & (T_star_jja.lat >= 60.) & (data_jja < 0.5))
...
mask_arctic_djf_ocean = T_star_djf.where((ice_n_djf_regrid < 100.) & (T_star_djf.lat >= 60.) & (data_djf < 0.5))
mask_arctic_djf_land = T_star_djf.where((land_mask_n_regrid == 0.) & (T_star_djf.lat >= 60.) & (data_djf < 0.5))


mask_antarctic_djf_ocean = T_star_djf.where((ice_s_djf_regrid < 100.) & (land_mask_s_regrid > 0.5) & (T_star_djf.lat <= -55.) & (T_star_djf.lat >= -75.) & (data_djf < 0.5))
...
mask_antarctic_jja_ocean = T_star_jja.where((T_star_jja.lon != 0) & (ice_s_jja_regrid < 100.) & (T_star_jja.lat <= -55.) & (data_jja < 0.5))
...
#mask_jja_n = np.ma.masked_less(data_jja.where(T_star_jja.where((ice_n_jja_regrid < 100.) & (land_mask_n_regrid == 1.) & (T_star_jja.lat >= 60.))), 0.5)

cs5 = axs[0,0].pcolor(lon2d-2.5, lat2d-2.5, mask_jja_n, hatch='xxx', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())
cs5 = axs[0,0].pcolor(lon2d-2.5, lat2d-2.5, mask_nan_jja, hatch='...', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())
cs5 = axs[0,1].pcolor(lon2d-2.5, lat2d-2.5, mask_jja_n, hatch='xxx', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())
cs5 = axs[0,1].pcolor(lon2d-2.5, lat2d-2.5, mask_nan_jja, hatch='...', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())


#mask_djf_n = np.ma.masked_less(data_djf.where(T_star_djf.where((ice_n_djf_regrid == 100.) & (T_star_djf.lat >= 60.))), 0.5)
cs5 = axs[0,2].pcolor(lon2d-2.5, lat2d-2.5, mask_djf_n, hatch='xxx', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())
cs5 = axs[0,2].pcolor(lon2d-2.5, lat2d-2.5, mask_nan_djf, hatch='...', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())
cs5 = axs[0,3].pcolor(lon2d-2.5, lat2d-2.5, mask_djf_n, hatch='xxx', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())
cs5 = axs[0,3].pcolor(lon2d-2.5, lat2d-2.5, mask_nan_djf, hatch='...', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())
cs5 = axs[0,4].pcolor(lon2d-2.5, lat2d-2.5, mask_djf_n, hatch='xxx', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())
cs5 = axs[0,4].pcolor(lon2d-2.5, lat2d-2.5, mask_nan_djf, hatch='...', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())
...
cs5 = axs[1,0].pcolor(lon2d-2.5, lat2d-2.5, mask_djf_s, hatch='xxx', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())
cs5 = axs[1,0].pcolor(lon2d-2.5, lat2d-2.5, mask_nan_djf, hatch='...', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())

cs5 = axs[1,2].pcolor(lon2d-2.5, lat2d-2.5, mask_jja_s, hatch='xxx', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())
cs5 = axs[1,2].pcolor(lon2d-2.5, lat2d-2.5, mask_nan_jja, hatch='...', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())

cs5 = axs[1,3].pcolor(lon2d-2.5, lat2d-2.5, mask_jja_s, hatch='xxx', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())
cs5 = axs[1,3].pcolor(lon2d-2.5, lat2d-2.5, mask_nan_jja, hatch='...', color = 'k', zorder = 100000, alpha=0.0 ,transform = ccrs.PlateCarree())
...
mask_area = area.where((ice_n_jja_regrid < 100.) & (land_mask_n_regrid == 1.) & (T_star_jja.lat >= 60.) & (data_jja < 0.5))
...
mask_area = area.where((ice_s_djf_regrid < 100.) & (land_mask_s_regrid > 0.5) & (T_star_djf.lat <= -55.) & (T_star_djf.lat >= -75.) & (data_djf < 0.5))
...
mask_area = area.where((T_star_jja.lon != 0) & (ice_s_jja_regrid < 100.) & (T_star_jja.lat <= -55.) & (data_jja < 0.5))
